...
/**
 * @brief This method is a copy paste from the pico library with some minor adjustments.
 *  This makes it a lot easier to incorporate the control byte without creating a
 *  whole new array.
 * @param device
 * @param buffer
 * @param buffer_length
