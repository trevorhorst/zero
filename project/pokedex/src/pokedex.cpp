...
const PokedexEntry pokedex[POKEDEX_NUM_POKEMON][POKEDEX_ENTRY_MAX] = {
    { "Bulbasaur",         "A strange seed was planted on its back at birth. The plant sprouts and grows with this POK\x82MON."},
    ...
    { "Blastoise",        "A brutal POK\x82MON with pressurized water jets on its shell. They are used for high speed tackles."},
    {  "Caterpie",        "Its short feet are tipped with suction pads that enable it to tirelessly climb slopes and walls."},
    {   "Metapod",        "This POK\x82MON is vulnerable to attack while its shell is soft, exposing its weak and tender body."},
    ...
    {    "Kakuna",    "Almost incapable of moving, this POK\x82MON can only harden its shell to protect itself from predators."},
    ...
    { "Pidgeotto",     "Very protective of its sprawling territorial area, this POK\x82MON will fiercely peck at any intruder."},
    ...
    {   "Pikachu",         "When several of these POK\x82MON gather, their electricity could build and cause lightning storms."},
    ...
    {"Nidoran \x02",       "Although small, its venomous barbs render this POK\x82MON dangerous. The female has smaller horns."},
    ...
    {"Nidoran \x01",        "Stiffens its ears to sense danger. The larger its horns, the more powerful its secreted venom."},
    {  "Nidorino",          "An aggressive POK\x82MON that is quick to attack. The horn on its head secretes a powerful venom."},
    ...
    {  "Clefable",            "A timid fairy POK\x82MON that is rarely seen. It will run and hide the moment it senses people."},
    ...
    {   "Psyduck",        "While lulling its enemies with its vacant look, this wily POK\x82MON will use psychokinetic powers."},
    ...
    {  "Arcanine",          "A POK\x82MON that has been admired since the past for its beauty. It runs agilely as if on wings."},
    ...
    {"Bellsprout",       "A carnivorous POK\x82MON that traps and eats bugs. It uses its root feet to soak up needed moisture."},
    ...
    {  "Rapidash",           "Very competitive, this POK\x82MON will chase anything that moves fast in the hopes of racing it."},
    ...
    {"Farfetch'd",                   "The sprig of green onions it holds is its weapon. It is used much like a metal sword."},
    ...
    {    "Gastly",           "Almost invisible, this gaseous POK\x82MON cloaks the target and puts it to sleep without notice."},
    {   "Haunter",            "Because of its ability to slip through block walls, it is said to be from another dimension."},
    {    "Gengar",         "Under a full moon, this POK\x82MON likes to mimic the shadows of people and laugh at their fright."},
    ...
    {    "Cubone",               "Because it never removes its skull helmet, no one has ever seen this POK\x82MON's real face."},
    ...
    {   "Chansey",               "A rare and elusive POK\x82MON that is said to bring happiness to those who manage to get it."},
    ...
    {    "Staryu",                 "An enigmatic POK\x82MON that can effortlessly regenerate any appendage it loses in battle."},
    ...
    {    "Lapras",          "A POK\x82MON that has been overhunted almost to extinction. It can ferry people across the water."},
    ...
    {   "Porygon",           "A POK\x82MON that consists entirely of programming code. Capable of moving freely in cyberspace."},
    {   "Omanyte",                   "Although long extinct, in rare cases, it can be genetically resurrected from fossils."},
    {   "Omastar",              "A prehistoric POK\x82MON that died out when its heavy shell made it impossible to catch prey."},
    {    "Kabuto",           "A POK\x82MON that was resurrected from a fossil found in what was once the ocean floor eons ago."},
    {  "Kabutops",     "Its sleek shape is perfect for swimming. It slashes prey with its claws and drains the body fluids."},
    {"Aerodactyl",     "A ferocious, prehistoric POK\x82MON that goes for the enemy's throat with its serrated saw-like fangs."},
    {   "Snorlax",          "Very lazy. Just eats and sleeps. As its rotund bulk builds, it becomes steadily more slothful."},
    {  "Articuno",         "A legendary bird POK\x82MON that is said to appear to doomed people who are lost in icy mountains."},
    {    "Zapdos",    "A legendary bird POK\x82MON that is said to appear from clouds while dropping enormous lightning bolts."},
    {   "Moltres",        "Known as the legendary bird of fire. Every flap of its wings creates a dazzling flash of flames."},
    {   "Dratini",      "Long considered a mythical POK\x82MON until recently when a small colony was found living underwater."},
    { "Dragonair",             "A mystical POK\x82MON that exudes a gentle aura. Has the ability to change climate conditions."},
    { "Dragonite",              "An extremely rarely seen marine POK\x82MON. Its intelligence is said to match that of humans."},
